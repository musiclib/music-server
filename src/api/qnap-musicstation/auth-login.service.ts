...
export class QnapAuthLoginService {
  ...
  async authenticate(
    ...
    return {
      ...
      QWebPort: this.configService.get('LAN_SERVER_PORT') || this.configService.get('SERVER_PORT'),
      webFSEnabled: 1,
      ...
      WFM2: 1,
      wfmPortEnabled: 0,
      wfmPort: this.configService.get('LAN_SERVER_PORT') || this.configService.get('SERVER_PORT'),
      wfmSSLEnabled: 0,
      wfmSSLPort: 443,
      wfmURL: '/filestation/',
      QMusicsEnabled: 1,
